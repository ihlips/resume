...
$("body").terminal(
  {
    education: function () {
      this.typing("echo", delay, Resume.education);
      // this.echo();
    },
    projects: function () {
      this.typing("echo", delay, Resume.activitiesAndProjects);
    },
    experience: function () {
      this.typing("echo", delay, Resume.workExperience);
    },
    skills: function () {
      this.typing("echo", delay, Resume.computerSkills);
    },
  },
  {
...
function greeting() {
  this.typing(
    "echo",
    delay,
    "Hi, my name is Ian and here's a little fun way to digest my resume\nHere are the options:\n\t*education\n\t*projects\n\t*experience\n\t*skills"
  );
}
